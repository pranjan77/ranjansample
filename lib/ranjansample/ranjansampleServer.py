...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'ranjansample'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from ranjansample.ranjansampleImpl import ranjansample
impl_ranjansample = ranjansample(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['ranjansample.myfunc1_async'] = ['ranjansample', 'myfunc1']
async_check_methods['ranjansample.myfunc1_check'] = ['ranjansample', 'myfunc1']
sync_methods['ranjansample.myfunc1'] = True
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_ranjansample.myfunc1,
                             name='ranjansample.myfunc1',
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "ranjansample but no authentication header was passed"
                            raise err
